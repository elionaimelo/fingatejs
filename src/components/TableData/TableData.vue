...
<template>
  <table class="w-full whitespace-nowrap" v-if="data.length">
    <thead>
      <tr>
        <th
    ...
    <tbody>
      ...
      >
        ...
        <td class="pl-5">
          <div class="flex items-center">{{ item.amount }}</div>
        </td>
        <td class="pl-4">
          <button
    ...
    <div class="my-5">
      <button
        class="px-4 py-2 mr-3 text-sm leading-none text-gray-700 border border-gray-200 rounded-lg hover:bg-gray-200 focus:outline-none"
